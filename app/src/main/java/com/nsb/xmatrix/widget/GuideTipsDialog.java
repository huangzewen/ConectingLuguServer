package com.nsb.xmatrix.widget;
...
import com.nsb.xmatrix.core.http.api.ApiService;
import com.nsb.xmatrix.core.http.callback.NoTipCallBack;
import com.nsb.xmatrix.core.http.entity.TipInfo;
import com.nsb.xmatrix.utils.MMKVUtils;
...
public class GuideTipsDialog extends BaseDialog implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private static final String KEY_IS_IGNORE_TIPS = "com.nsb.xmatrix.widget.key_is_ignore_tips_";
