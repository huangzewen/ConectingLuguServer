...
package com.nsb.xmatrix.fragment.component.imageview.preview;
...
import com.nsb.xmatrix.adapter.NineGridRecycleAdapter;
...
public class NineGridImageViewFragment extends BaseFragment {
    ...
    protected TitleBar initTitle() {
        ...
        titleBar.addAction(new TitleBar.TextAction("Switch") {
            @Override
