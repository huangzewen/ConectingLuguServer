...
public class SettingSPUtils extends BaseSPUtil {
    ...
    private static volatile com.nsb.xmatrix.utils.SettingSPUtils sInstance = null;
     ...
     * @return
     */
    public static com.nsb.xmatrix.utils.SettingSPUtils getInstance() {
        if (sInstance == null) {
            synchronized (com.nsb.xmatrix.utils.SettingSPUtils.class) {
                if (sInstance == null) {
                    sInstance = new com.nsb.xmatrix.utils.SettingSPUtils(XUtil.getContext());
                }
            }
        }
        return sInstance;
